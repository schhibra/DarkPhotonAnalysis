...
process.mmtree = cms.EDAnalyzer("TreeMaker",
    ...
    applyDimuonFilter = cms.bool(True),
    applyHLTFilter = cms.bool(True),
    data = cms.string('Rochester/RoccoR2017.txt'),
    doL1 = cms.bool(True),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('94X_dataRun2_ReReco17_forValidation'),
