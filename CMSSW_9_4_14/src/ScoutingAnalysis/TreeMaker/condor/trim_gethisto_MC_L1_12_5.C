...
//void trim_gethisto_MC_L1_12_5(const char* treepath = "/eos/cms/store/group/phys_exotica/darkPhoton/schhibra/ScoutingNTuples2017/tree_DarkPhotonToMuMu_M12p5.root", const char* outfilename = "test.root") {
