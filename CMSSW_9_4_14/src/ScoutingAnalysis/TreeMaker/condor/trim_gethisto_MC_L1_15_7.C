...
void trim_gethisto_MC_L1_15_7(const char* treepath = "DATASET", const char* outfilename = "OUTPUT") {

//void trim_gethisto_MC_L1_15_7(const char* treepath = "/eos/cms/store/group/phys_exotica/darkPhoton/schhibra/ScoutingNTuples2017/tree_DarkPhotonToMuMu_M20.root", const char* outfilename = "test.root") {
