...
void trim_gethisto_MC_L1_15_7_tmp(const char* treepath = "/eos/cms/store/group/phys_exotica/darkPhoton/schhibra/ScoutingNTuples2017/tree_DarkPhotonToMuMu_M70.root", const char* outfilename = "/eos/cms/store/group/phys_exotica/darkPhoton/schhibra/ScoutingNTuples2017/jobs_MC/histos/trim_L1_15_7_DarkPhotonToMuMu_M70.root") {

//void trim_gethisto_MC_L1_15_7_tmp(const char* treepath = "/eos/cms/store/group/phys_exotica/darkPhoton/schhibra/ScoutingNTuples2017/tree_DarkPhotonToMuMu_M20.root", const char* outfilename = "test.root") {
  ...
  fileInputData = TFile::Open("/afs/cern.ch/work/s/schhibra/DarkPhotonSearch_v2/CMSSW_9_4_14/src/ScoutingAnalysis/TreeMaker/condor/pudata_L1_12_5_off.root");
  ...
  while(reader.Next()) {
    ...
    //data with 12_5 off: if any of the 3 seeds is true, process that event

    if ((*l1Result)[4] == 1 || (*l1Result)[11] == 1 || (*l1Result)[12] == 1) {
	...
	exweight_Z *= idisohist_overlap_Z->GetBinContent(idisohist_overlap_Z->FindBin(pt2));
      ...
      double weight   = 8300 * puweight * exweight   * mcweight;
      double weight_Y = 8300 * puweight * exweight_Y * mcweight;
      double weight_Z = 8300 * puweight * exweight_Z * mcweight;
      ////////////////////////////////////////////////////////////////////////
